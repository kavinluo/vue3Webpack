 ...
 * @LastEditTime: 2023-03-22 13:46:41
 * @Description: 考点管理
-->
<template>
  <div>
    <el-row>
      <el-col :span="12">
        ...
        <!-- <el-button type="primary" @click="enableHandel">启用</el-button>
        <el-button type="primary" @click="disEnableHandel">暂停</el-button> -->
      </el-col>
    ...
    <kv-table
      ref="myTable"
      :getDataFn="getRoomList"
      :propList="columns"
      :params="from"
      @handleSelectionChange="handleSelectionChange"
      :showSelectColumn="true">
      <template #schoolsName="scope">
         <a href="##" @click="handleShow(scope.row)">{{ scope.row.schoolsName }} </a>
      </template>
  </kv-table>
  </div>
<!-- 新建 -->
